...
AddCSLuaFile("damagelogs/not_my_code/coloredbox.lua")
AddCSLuaFile("damagelogs/not_my_code/util.lua")
...
hook.Add("PlayerDeath", "Damagelog_PlayerDeathLastLogs", function(ply)
	if ( JB.State == STATE_SETUP or JB.State == STATE_PLAYING or JB.State == STATE_LASTREQUEST ) and Damagelog.Time then
		local found_dmg = {}
